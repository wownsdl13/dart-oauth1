...
void main() {
  ...
  final ClientCredentials clientCredentials = ClientCredentials(apiKey, apiSecret);

  test('request temporary credentials', () {
    final Authorization auth = Authorization(clientCredentials, twitter1_1, http.Client());
